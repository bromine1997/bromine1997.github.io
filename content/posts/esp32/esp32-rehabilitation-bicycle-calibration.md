...
date: 2026-06-02T20:17:00+09:00
draft: false
categories:
  - Embedded
tags:
...
실제로는 측정값을 엑셀에 입력해 기울기를 구했다. 수식을 직접 계산할 필요 없이 산점도를 그리고 추세선을 추가하면 기울기가 바로 나온다.
...
3. 분동 올리고 시리얼 출력 읽기
4. 측정값을 엑셀에 입력해 원점 통과 직선의 기울기로 게인 계산
