...
tags:
  ...
  - 임베디드
  - 리팩토링
summary: "학부 시절 ATmega4809로 작성했던 펌웨어 코드를 다시 꺼내 코드리뷰 형태로 정리하는 시리즈를 시작한다. 단순히 동작하는 코드가 아닌, 잘 짜여진 코드를 찾아가는 과정이다."
---
...
단순히 동작하는 코드가 아니라 **잘 짜인 코드를 찾아가는 과정**이라고 보면 된다.
...
잘 짠 코드가 뭔지 아직도 잘 모르겠지만, 그걸 찾아가는 과정을 기록으로 남겨두려 한다.
