...
![잘 튜닝된 PID(좌)와 잘못 튜닝된 PID(우) — 에어컨 온도 제어 예시](/images/control-theory/pid-step-comparison.png)
...
![HBOT 압력 제어 — 잘 튜닝된 PID 응답](/images/control-theory/pid-hbot-response.png)
